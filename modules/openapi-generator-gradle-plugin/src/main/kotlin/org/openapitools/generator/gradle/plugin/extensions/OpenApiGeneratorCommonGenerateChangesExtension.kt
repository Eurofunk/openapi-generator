...
/**
 * Gradle project level extension object definition of common parts
 * for the `generate` and `changes` tasks
 *
 * @author Jim Schubert
 */
open class OpenApiGeneratorCommonGenerateChangesExtension(project: Project) {
    /**
